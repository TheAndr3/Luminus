...
// Importa hooks do React. (OBS: `use` não está sendo usado e provavelmente foi importado por engano.)

import class_icon from "@/components/icon/icon_classroom.svg" 
// Importa um ícone SVG (nesse caso, parece não estar sendo utilizado no código).

import Image from "next/image"; 
// Importa o componente `Image` do Next.js, que serve para otimizar imagens (também não está sendo usado no momento).
